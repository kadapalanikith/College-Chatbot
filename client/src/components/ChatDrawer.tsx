...
export default function ChatDrawer({ open, onClose }: ChatDrawerProps) {
  ...
  return (
    <div
      className="fixed bottom-24 right-4 sm:right-6 z-50 flex flex-col shadow-2xl rounded-2xl overflow-hidden border border-gray-200"
      style={{
    ...
    >
      {/* Header */}
      <div className="bg-maroon px-4 py-3 flex items-center justify-between shrink-0">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-white/70 text-xs">
              {sending ? "Typing..." : "Ask me anything"}
            </p>
          </div>
        </div>
        <div className="flex items-center gap-1">
          <button
            onClick={onClose}
            className="text-white/70 hover:text-white p-1.5 rounded transition-colors duration-200"
      ...
      <div className="bg-white border-t border-gray-200 p-3 shrink-0">
        <div className="flex items-center gap-2">
          <input
            ...
            disabled={sending}
            className="flex-1 px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-maroon text-sm disabled:opacity-50 transition-colors duration-200 min-w-0"
          />
          <button
            onClick={() => handleSend()}
